...
![<https://hellodata.science/>](img/logo.png){fig-alt="Hello Data Science logo of dots colored into three clusters."}

## Released chapters {background-image="img/logo.png" background-size="35px" background-position="right 20px top 10px" background-repeat="no-repeat" fig-alt="Hello Data Science logo of dots colored into three clusters."}
...
## Highlights {background-image="img/logo.png" background-size="35px" background-position="right 20px top 10px" background-repeat="no-repeat" fig-alt="Hello Data Science logo of dots colored into three clusters."}
